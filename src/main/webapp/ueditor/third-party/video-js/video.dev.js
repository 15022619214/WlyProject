...
================================================================================ */
/**
 * The SubMenu component is used to build pop up menus, including subtitle and
...
vjs.Menu.prototype.createEl = function(){
  ...
  // Prevent clicks from bubbling up. Needed for SubMenu Buttons,
...
/**
 * SubMenu button with a popup for showing the volume slider.
 * @constructor
 */
...
//   var menu = new vjs.SubMenu(this.player_);
...
vjs.CaptionsButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    ...
    this.el_.setAttribute('aria-label','Captions SubMenu');
  }
});
...
vjs.SubtitlesButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    vjs.TextTrackButton.call(this, player, options, ready);
    this.el_.setAttribute('aria-label','Subtitles SubMenu');
  }
});
...
vjs.ChaptersButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    vjs.TextTrackButton.call(this, player, options, ready);
    this.el_.setAttribute('aria-label','Chapters SubMenu');
  }
});
